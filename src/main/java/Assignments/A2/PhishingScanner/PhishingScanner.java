package Assignments.A2.PhishingScanner;
...
public class PhishingScanner {
    public static void main(String[] args) {
        ...
        Path PhisingTerms = Paths.get("src/main/java/Assignments/A2/PhishingScanner/PhishingTerms.txt");
    ...
    private static List<String> readEmail() {
        ...
        Path path = Paths.get("src/main/java/Assignments/A2/PhishingScanner/FakeEmail2.txt");
        try {
